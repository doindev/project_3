...
public class TelnetConstants {
    ...
    // 3270 Orders
    public static final byte SF = (byte) 0x1D;    // Start Field
    public static final byte SFE = (byte) 0x29;   // Start Field Extended
    public static final byte SBA = (byte) 0x11;   // Set Buffer Address
    public static final byte SA = (byte) 0x28;    // Set Attribute
    public static final byte MF = (byte) 0x2C;    // Modify Field
    public static final byte IC = (byte) 0x13;    // Insert Cursor
    public static final byte PT = (byte) 0x05;    // Program Tab
    public static final byte RA = (byte) 0x3C;    // Repeat to Address
    public static final byte EUA = (byte) 0x12;   // Erase Unprotected to Address
    public static final byte GE = (byte) 0x08;    // Graphics Escape
    
    // Write Control Characters
    public static final byte WCC_RESET = (byte) 0x40;
    public static final byte WCC_PRINT = (byte) 0x08;
    public static final byte WCC_START_PRINTER = (byte) 0x04;
    public static final byte WCC_SOUND_ALARM = (byte) 0x02;
    public static final byte WCC_KEYBOARD_RESTORE = (byte) 0x01;
    
    // Field Attributes
    public static final byte ATTR_PROTECTED = (byte) 0x20;
    public static final byte ATTR_NUMERIC = (byte) 0x10;
    public static final byte ATTR_DISPLAY_MASK = (byte) 0x0C;
    public static final byte ATTR_INTENSITY_MASK = (byte) 0x08;
    public static final byte ATTR_MDT = (byte) 0x01;  // Modified Data Tag
    
    // Display Attributes
    public static final byte DISPLAY_NORMAL = (byte) 0x00;
    public static final byte DISPLAY_INVISIBLE = (byte) 0x08;
    public static final byte DISPLAY_INTENSE = (byte) 0x04;
    public static final byte DISPLAY_NONDISPLAY = (byte) 0x0C;
    
    // Structured Field Orders
    public static final byte SF_READ_PARTITION = (byte) 0x01;
    public static final byte SF_ACTIVATE_PARTITION = (byte) 0x0E;
    public static final byte SF_DESTROY_PARTITION = (byte) 0x0F;
